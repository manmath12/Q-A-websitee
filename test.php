...
?>
  ...
  <h4><p class="welcome" style="font-family: Russo one; margin-top: 5px;">Welcome to question and answer</p></h4>
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                <div class="card mb-3 bg-dark" style="color: white;">
                  <div class="card-body">
                    <h5 class="card-title" id="question">';
    ...
    <div class="container">
        <div class="card bg-dark">
            ...
            <form class="card-sm" role="search" action="insert.php" method="post"
                style="padding-right: 5px; margin: 10px;">

                
    <input type="text" id="username" name="username" class="form-control" placeholder="Enter name" required  style="margin:5px;" >
    <textarea id="question" name="question" class="form-control me-2" type="search" placeholder="question" aria-label="Answer" style="margin:5px;" required></textarea>
    <textarea id="question_desc" name="question_desc" class="form-control me-2" type="search" placeholder="Description" aria-label="Answer" style="margin:5px;" required></textarea>
    ...
    <footer>
        ...
        <div class="container-fluid text-center bg-dark" data-bs-theme="dark"
            style="border-top:1px solid black; margin-top: 5px;">
            <div class="row bg-dark" data-bs-theme="dark">
                <div class="col">
                    <pre>
